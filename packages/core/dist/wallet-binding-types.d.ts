...
export declare const WALLET_BINDING_PURPOSE: "urn:coordination-games:wallet-binding:v1";
...
export type WalletBindingRejectionReason = 'invalid-record' | 'record-version' | 'expected-did' | 'expected-domain' | 'expected-uri' | 'expected-chain-id' | 'expected-nonce' | 'stale' | 'future' | 'inactive-lifecycle' | 'unsupported-signature-type' | 'invalid-signature' | 'signer-mismatch' | 'nonce-reused';
...
//# sourceMappingURL=wallet-binding-types.d.ts.map