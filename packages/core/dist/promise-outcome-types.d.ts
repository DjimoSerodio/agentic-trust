...
export declare const PROMISE_OUTCOME_ATTESTATION_VERSION: "promise-outcome-attestation/v1";
export declare const PROMISE_OUTCOME_EAS_SCHEMA: "string actorDid,string subjectDid,uint8 outcome,string gameId,uint64 sequence,string evidenceUri,string evidenceCid,uint64 observedAtMs,string eventVersion,string schemaVersion,string algorithmVersion,bytes32 eventDigest";
...
export type PromiseOutcomeCreationResult = {
    ...
    readonly attestation: PromiseOutcomeAttestation;
...
export type DecodedPromiseOutcomeResult = {
    ...
    readonly decoded: DecodedPromiseOutcome;
} | {
    readonly kind: 'rejected';
...
export type EasGatewaySubmission = {
    ...
    readonly kind: 'rejected';
    readonly reason: 'gateway-rejected';
};
...
export type PromiseOutcomeAnchorResult = {
    ...
    readonly record: PromiseOutcomeAnchorRecord;
} | PromiseOutcomeRejected | {
    readonly kind: 'rejected';
    readonly reason: 'invalid-anchor' | 'gateway-rejected';
};
export type PromiseOutcomeQueryResult = {
    ...
    readonly kind: 'rejected';
    readonly reason: 'invalid-uid' | 'invalid-attestation' | 'schema-mismatch' | 'recipient-mismatch' | 'attester-mismatch' | 'revoked' | 'expired' | 'invalid-data' | 'digest-mismatch';
};
...
//# sourceMappingURL=promise-outcome-types.d.ts.map